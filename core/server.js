...
app.use("/tmp0",express.static('../../UNDONE')) 
app.use("/tmp1",express.static('../'))
app.use("/files",express.static('files'))
//app.use("imgs",express.static('public/imgs'))
//app.use("/imgs",(r,rr)=>{rr.end('okk')})
app.use("/imgs",express.static('public/imgs'))
...
// })
// .listen(settings.port,()=>{console.log("connecté au port "+settings.port_plesk)})